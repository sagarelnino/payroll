  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><a data-toggle="modal" class="btn btn-lg btn-success" href="#instructor" role="button">Brought To You By: Example</a></p>
      </div>

      <!-- Site footer -->
      <footer class="footer">
        <p align="center">&copy; 2018 PAYROLL MANAGEMENT SYSTEM</p>
        <p align="center">Brought To You By<a target="_blank" href="http://code-projects.org/">Example</a></p>
      </footer>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <div align="center">
                <a href="https://example.org/" target="_blank" title="code-projects"><big><b> Example</b></big></a>
              </div>
            </div>
          </div>
        </div>
